...
class PagoService:
    ...
    def _simular_pasarela_pagos(self, datos_tarjeta: dict = None, simular_rechazo: bool = False) -> Dict[str, Any]:
    ...
    def procesar_pago(self, usuario_id: int, data) -> Dict[str, Any]:
        ...
        with reserva_lock:
            ...
            simular_rechazo = getattr(data, 'simular_rechazo', False)
            resultado_pasarela = self._simular_pasarela_pagos(data.datos_tarjeta, simular_rechazo)
